...
public class tenant_acco extends HttpServlet {
    ...
    public void Validation(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
      ...
      //String fpass  = request.getParameter("pass");   
        ...
        { 
            ...
            sql = "Select fname,mname,lname,street,city,phnnum,email from house_details " + "where (zipcode  = '"+bZipcode+"');";
           ...
           /*int m = st.executeUpdate(sql); */
            ...
            writer.println("<center><h1 style=\"font-size:40px\">HOUSES AVAILABLE IN "+bZipcode+"</h1>");
            writer.println("<table style=\"font-size:20px; text-align:center;\" border=4 width=90% height=30%>"); 

           // writer.println("<table border=1 width=100% height=50%>");  
            
            writer.println("<tr style=\"color:red; font-size:30px\"><th>First Name</th><th>Middle Name</th><th>Last Name</th><th>Street</th><th>City</th><th>Phnnum</th><th>Email</th><tr><style='font-size:60px;'>");            int row = 0;
            while(rs.next()) {
